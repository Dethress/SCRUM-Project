...
// --- A3: WejÅ›cie z debounce + auto-repeat (polling) ---
typedef enum { DIR_NONE=0, DIR_UP, DIR_DOWN, DIR_LEFT, DIR_RIGHT } Dir;

#define BTN_DEBOUNCE_MS       20U    // filtr drgaÅ„ stykÃ³w
#define BTN_REPEAT_DELAY_MS  160U    // po tyle ms pierwszy powtÃ³rzony krok
#define BTN_REPEAT_MS         80U    // odstÄ™p kolejnych krokÃ³w przy trzymaniu
